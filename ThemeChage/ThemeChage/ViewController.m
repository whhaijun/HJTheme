...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = self.dataSource[indexPath.section][indexPath.row].allKeys.firstObject;
    cell.indentationLevel = 1;
    cell.textLabel.hj_themeTextColor = mainTextColorKey;
